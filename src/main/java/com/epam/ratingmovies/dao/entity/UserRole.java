...
public enum UserRole {
    USER(MOVIES_PAGE,SIGN_UP_PAGE,LOGIN_PAGE,
            REVIEWS_PAGE,MOVIE_PAGE,LOGIN,SIGN_UP,LOCALIZATION,ACCOUNT_SETTINGS_PAGE,PROFILE_PAGE,
            CHANGE_GENERAL_INFO,LOGOUT,LEAVE_COMMENT,CHANGE_PASSWORD),

    ADMIN(SIGN_UP_PAGE,ACCOUNT_SETTINGS_PAGE,
            MOVIES_PAGE,LOGIN_PAGE,PROFILE_PAGE,CHANGE_GENERAL_INFO,LOGOUT,REVIEWS_PAGE,
            MOVIE_PAGE,LEAVE_COMMENT,CREATE_MOVIE_PAGE,LOGIN,SIGN_UP,
            USERS_PAGE,CHANGE_PASSWORD,ACTION_BAN_USER,ACTION_UNBAN_USER,LOCALIZATION,CREATE_MOVIE),
