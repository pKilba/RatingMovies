                        ...
                        <c:forEach var="i" begin="1" end="${maxPage}">
                            ...
                            || (i > maxPage-2) || (i == 1)}">
                                <li class="page-item <c:if test="${currentPage == i}">active</c:if>">
                                    <a class="page-link"
                                       href="${pageContext.request.contextPath}/ratingMovies?command=reviews-page&id=${id}&p=<c:out value = "${i}"/>&s=${amountOfPage}">
                                        <c:out value="${i}"/>
                                    </a>
                                </li>
                            </c:if>
...
<div class="col-lg-4 col-md-5 col-sm-4 offset-md-1 offset-sm-1 col-12 mt-4">
    <form id="algin-form" method="POST"
          action="${pageContext.request.contextPath}/ratingMovies?command=leaveComment">
